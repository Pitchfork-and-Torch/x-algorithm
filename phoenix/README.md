...
```shell
# maps uname -m (x86_64 / aarch64) onto protobuf's linux-x86_64 / linux-aarch_64 names
PROTOC_ARCH=$(uname -m | sed 's/aarch64/aarch_64/')
curl -fsSL -o /tmp/protoc.zip https://github.com/protocolbuffers/protobuf/releases/download/v28.3/protoc-28.3-linux-${PROTOC_ARCH}.zip
